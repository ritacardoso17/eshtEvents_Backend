...
function getRents(callback) {
    const sql = "SELECT id_aluguer, utilizador.nome as user, data_hora_aluguer, data_hora_requirida, duracao, estado.descritivo as estado, tipo_espaco.descritivo as espaco, motivo, opiniao FROM aluguer_espaco, estado, utilizador, tipo_espaco WHERE utilizador.id_utilizador = aluguer_espaco.id_utilizador AND estado.id_estado = aluguer_espaco.id_estado AND tipo_espaco.id_espaco = aluguer_espaco.id_espaco;"
