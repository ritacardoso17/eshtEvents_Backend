...
function addReservations(req, result) {
    ...
    reservationFunctions.addReservations(id_user, n_people, date_reserv, date_required, id_uniform, id_reservType, id_menu, id_local, id_decoration, opinion, (error, sucess) => {
        if (error) {
            throw error
            return
        }
